...
class CustomCharacterHeaderWithVideo extends SliverPersistentHeaderDelegate {
  final String bgUrl;
  final String text;

  CustomCharacterHeaderWithVideo({required this.bgUrl, required this.text});
  ...
  Widget build(
    ...
    return Stack(
      ...
      children: [
        ...
        // ),
        Container(
          child: YoutubePlayerWidget(videoId: bgUrl),
        ),
        Container(
